# Graph Report - sielsoord  (2026-07-18)

## Corpus Check
- 14 files · ~38,077 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 202 nodes · 141 edges · 91 communities (13 shown, 78 thin omitted)
...
1. `Sielsoord — Die Storie` - 9 edges
2. `Sielsoord — Waar jou siel tot rus kom` - 8 edges
3. `Home Page` - 8 edges
4. `t()` - 6 edges
5. `initSielsoordMap()` - 6 edges
6. `init()` - 5 edges
7. `mapT()` - 5 edges
8. `getPopupContent()` - 5 edges
9. `renderBubbles()` - 4 edges
10. `openCategory()` - 4 edges
...
## Communities (91 total, 78 thin omitted)

### Community 0 - "Home Page Logic"
Cohesion: 0.12
Nodes (13): Sielsaandster Detail Page, Sielskemering Detail Page, Sielsrus Detail Page, Sunset over Sielsoord (Dark), Sunset over Sielsoord (Light), Home Page, clearError(), showError() (+5 more)

### Community 1 - "Interactive Map Component"
Cohesion: 0.26
Nodes (11): FEATURE_STYLES, getDisplayName(), getFeatureStyle(), getHillStyle(), getPopupContent(), HILL_NAMES, initSielsoordMap(), injectPopupStyles() (+3 more)

### Community 2 - "Gallery Navigation and Lightbox"
Cohesion: 0.33
Nodes (8): Gallery Page, format(), initGallery(), navLightbox(), openCategory(), openLightbox(), renderBubbles(), t()
...
Cohesion: 0.17
Nodes (11): Accessibility, Colours (Namibian Earth Palette), Design System, File Structure, Pages, Quick Start, Sielsoord — Waar jou siel tot rus kom, Tech (+3 more)

### Community 89 - "Sielsoord — Die Storie"
Cohesion: 0.20
Nodes (9): Die Bome — Wagters van die Veld, Die Geleentheid — Sewe Koppies, Sewe Koninkryke, Die Land — 'n Erfenis van Rots en Ruimte, Die Lug — 'n Koninkryk van Vlerke, Die Seisoene — Twee Wêrelde op Een Plek, Die Wild — Bure van Genade en Krag, Jou Siel Se Rus Wag, Sielsoord — Die Storie (+1 more)

## Knowledge Gaps
- **133 isolated node(s):** `HILL_NAMES`, `FEATURE_STYLES`, `SIELSOORD_GEOJSON`, `SIELSOORD_KML_FEATURES`, `TRANSLATIONS` (+128 more)
...
- **Why does `Home Page` connect `Home Page Logic` to `Internationalization and Language Switcher`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **What connects `HILL_NAMES`, `FEATURE_STYLES`, `SIELSOORD_GEOJSON` to the rest of the system?**
  _133 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Home Page Logic` be split into smaller, more focused modules?**
